...
public class MannerEstimationLogic(ILogger<MannerEstimationLogic> logger, IMannerEstimationServiceDependencies dependencies, IOrganicManureLogic organicManureLogic, IHttpContextAccessor httpContextAccessor, IRb209Service rb209Service) : IMannerEstimationLogic
{
    ...
    public async Task<MannerEstimationStep26ViewModel> GetMannerEstimationStep26()
    {
        ...
        mannerEstimationViewModel.MannerEstimationStep26.IsFarmOrganic = mannerEstimationViewModel.MannerEstimationStep17.IsFarmOrganic;
        mannerEstimationViewModel.MannerEstimationStep26.IsWithinNVZ = mannerEstimationViewModel.MannerEstimationStep6.IsWithinNVZ;
    ...
    public async Task<MannerEstimationStep27ViewModel> GetMannerEstimationStep27()
    {
        ...
        mannerEstimationViewModel.MannerEstimationStep27.IsFarmOrganic = mannerEstimationViewModel.MannerEstimationStep17.IsFarmOrganic;
        mannerEstimationViewModel.MannerEstimationStep27.IsWithinNVZ = mannerEstimationViewModel.MannerEstimationStep6.IsWithinNVZ;
    ...
    public async Task<MannerEstimationStep28ViewModel> GetMannerEstimationStep28()
    {
        ...
        mannerEstimationViewModel.MannerEstimationStep28.IsFarmOrganic = mannerEstimationViewModel.MannerEstimationStep17.IsFarmOrganic;
        mannerEstimationViewModel.MannerEstimationStep28.IsWithinNVZ = mannerEstimationViewModel.MannerEstimationStep6.IsWithinNVZ;
    ...
    public async Task<Error?> CopiedFarmAndFieldData(int farmId, int fieldId, string? sid = null)
    {
        ...
        if (farm != null)
        {
            ...
            mannerEstimationViewModel.MannerEstimationStep5.CountryId = farm.CountryID;
            ...
            mannerEstimationViewModel.MannerEstimationStep18.CountryId = farm.CountryID;
   ...
   ?.name ?? string.Empty;
    ...
    public async Task<Error?> BindMannerEstimationDataForUpdate(int mannerEstimateId, string? sid = null)
    {
        ...
        if (mannerEstimate != null && string.IsNullOrWhiteSpace(error?.Message))
        {
            ...
            mannerEstimationViewModel.MannerEstimationStep5.CountryId = mannerFarm.CountryID;
            ...
            mannerEstimationViewModel.MannerEstimationStep18.CountryId = mannerFarm.CountryID;
