...
public class StoreCapacity
{
    ...
    [Range(typeof(decimal), "0", "999", ErrorMessageResourceType = typeof(Resource), ErrorMessageResourceName = nameof(Resource.MsgEnterAValueBetween0And999))]
    ...
    [Range(typeof(decimal), "0", "99", ErrorMessageResourceType = typeof(Resource),ErrorMessageResourceName = nameof(Resource.MsgEnterAValueBetween0And99))]
    ...
    [Range(typeof(decimal), "0", "9999999999", ErrorMessageResourceType = typeof(Resource), ErrorMessageResourceName = nameof(Resource.MsgEnterAValueBetween0And9999999999))]
